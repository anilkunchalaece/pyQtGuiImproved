...
class Ui_prepare2Pg(object):
    def setupUi(self, prepare2Pg):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 1021, 141))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(-1, -1, 1031, 131))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        self.scrollAreaWidgetContents = QtGui.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1029, 129))
